...
public class Juego {
    ...
    public static void main(String[] args) {
        ...
        Carta cartaPrueba = new Carta(Palo.CORAZONES, 1); // As de corazones
    ...
    private static void menuInteraccion(Mazo mazo, ArrayList<Jugador> jugadores, Scanner scanner) {
        while (true) {
            ...
            switch (opcion) {
                ...
                case 7 -> visualizarCarta(mazo, scanner);
                case 8 -> {
    ...
    // Método para regresar una carta al mazo
    ...
    // Método para visualizar una carta específica
    private static void visualizarCarta(Mazo mazo, Scanner scanner) {
        ...
        try {
            ...
            Carta carta = new Carta(palo, valor);
            Visualizador.carta(carta, new Posicion(50, 50));
